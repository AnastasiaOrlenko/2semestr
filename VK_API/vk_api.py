...
'''
    ...
    return lenghtt  
    #пыталась понять как могу сделать подсчет, многими вариантами, поэтому здесь может быть много бреда с разных вариантов
...
def main():
    ...
    lenghtt = lenghtofposts(new_posts)
