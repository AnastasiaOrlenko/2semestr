...
A = []
def poisk():
    sites = ['http://runews24.ru/culture/03/12/2016/0b1e9ad3de5d3a866840728cb5fe9110',
                        'http://www.vesti.ru/doc.html?id=2828727']
    for i in sites:
        wep = func1(i)
        regex = re.search ('<div (class="desc text"|class="js-mediator-article")>(.*?)</div>', wep, flags = re.DOTALL)
