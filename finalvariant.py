...
if __name__ == '__main__':
    ...
    #совсем запуталась. спустя некоторое время даже перестал писать текст, хотя делал это. дописала оследние три функции по конспектам и мыслям, но не усерена в их работе, поскольку с самим кодом возникли проблемы.
